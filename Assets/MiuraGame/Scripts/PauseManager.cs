...
public class PauseManager : MonoBehaviour
{
    ...
    private enum PausePanelState { ReturnSelect, Option, Close }
    private PausePanelState pauseState = PausePanelState.Close;
    private enum VolumePanelState { Master = 0, BGM, SE, Close }
    ...
    private void ChangePauseTextsColor()
    {
        // テキストの色を変更
    ...
    private void ChangeVolumeTextsColor()
    {
        // テキストの色を変更
